...
SELECT d.DEPARTMENT_NAME, l.LOCATION_ID, COUNTRY_ID
FROM DEPARTMENTS d
    RIGHT OUTER JOIN LOCATIONS l ON l.LOCATION_ID = d.LOCATION_ID ORDER BY 1;

SELECT DISTINCT LOCATION_ID FROM DEPARTMENTS;

SELECT l.LOCATION_ID, c.COUNTRY_NAME FROM LOCATIONS l
INNER JOIN COUNTRIES c ON l.COUNTRY_ID = c.COUNTRY_ID;

-- SET OPERATORS IN SQL : UNION, UNION ALL, MINUS, INTERSET
